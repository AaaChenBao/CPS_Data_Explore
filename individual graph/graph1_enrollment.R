...
enroll <- read_excel(here("data/enrollment", 
               "Demographics_20thDay_2019.xls"), sheet = "Schools")


# read in files
enroll_2019 <-
  read_excel("Demographics_20thDay_2019.xls", sheet = "Schools") %>%
  filter(enroll_2019, "School Name" == "District Total 2018-2019")
...
enroll_2018 <-
  read_excel("Demographics_20thDay_2018.xls", sheet = "Schools")
enroll_2018 <-
...
enroll_2017 <- 
  read_excel("Demographics_20thDay_2017.xls", sheet = "Schools")
enroll_2017 <-
...
enroll_2016 <- 
  read_excel("Demographics_20thDay_2016.xls", sheet = "Sheet1")
enroll_2016 <-
...
enroll_2015 <- 
  read_excel("Demographics_20thDay_2015.xls", sheet = "Sheet1")
enroll_2015 <-
...
enroll_2014 <- 
  read_excel("Demographics_20thDay_2014.xls", sheet = "enrollment_20th_day_2014")
enroll_2014 <-
...
enroll_2013 <- 
  read_excel("Demographics_20thDay_2013.xls", sheet = "enrollment_20th_day_2013")
enroll_2013 <-
...
enroll_2012 <- 
  read_excel("Demographics_20thDay_2012.xls", sheet = "enrollment_20th_day_2012")
enroll_2012 <-
...
enroll_2011 <- 
  read_excel("Demographics_20thDay_2011.xls", sheet = "enrollment_20th_day")
enroll_2011 <-
...
enroll_2010 <- 
  read_excel("Demographics_20thDay_2010.xls", sheet = "Sheet1")
enroll_2010 <-
...
enroll_2009 <- 
  read_excel("Demographics_20thDay_2009.xls", sheet = "Query1")
enroll_2009 <- 
...
enroll_2008 <- 
  read_excel("Demographics_20thDay_2008.xls", sheet = "Sheet1")
enroll_2008 <- 
...
enroll_2007 <- 
  read_excel("Demographics_20thDay_2007.xls", sheet = "Sheet1")
enroll_2007 <- 
...
enroll_2006 <- 
  read_excel("Demographics_20thDay_2006.xls", sheet = "enrollment_0608")
enroll_2006 <- 
